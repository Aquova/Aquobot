...
fact_list = ["Did you know that Sonic 3 isn't the 3rd game in the series? Sonic CD was released between Sonic 2 and 3, which is why all levels have the roman numeral 'III' at the start.",
            ...
            "The theme of Ice Cap Zone in *Sonic 3* is actually an instrumental version of the unrealesed song *Hard Time* by the Jetzons. The keyboardist of the band, Bruce Buxor, later worked on Sonic 3 and added the song to the game.",
